...
public class App1 {
    public static void main(String[] args) {
        ...
        System.out.println("Ket qua so sanh bang cua 2 so " + firstNumber + " va " + 
                secondNumber + " la " + (firstNumber == secondNumber));
        System.out.println("Ket qua so sanh khong bang cua hai so " + firstNumber + " va " + 
                secondNumber + " la " + (firstNumber != secondNumber));
        System.out.println("Ket qua so sanh lon hon 2 so " + firstNumber + " va " + 
                secondNumber + " la " + (firstNumber > secondNumber));
        System.out.println("Ket qua so sanh lon hon hoac bang cua 2 so " + firstNumber + " va " + 
                secondNumber + " la " + (firstNumber >= secondNumber));
        System.out.println("Ket qua so sanh nho hon cua 2 so " + firstNumber + " va " + 
                secondNumber + " la " + (firstNumber < secondNumber));
        System.out.println("Ket qua so sanh nho hon hoac bang cua 2 so " + firstNumber + " va " + 
                secondNumber + " la " + (firstNumber <= secondNumber));
    }
